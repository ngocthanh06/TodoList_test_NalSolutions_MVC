                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="external-events">
                                        <div class="external-event bg-success">Planning</div>
                                        <div class="external-event bg-warning">Doing</div>
                                        <div class="external-event bg-info">Complete</div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                            </div>
